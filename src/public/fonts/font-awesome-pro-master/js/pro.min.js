!(function () {
            ...
            J =
                a.found && n.found
                    ? ((S = (k = B).children),
                      ...
                      (F = {
                          tag: 'rect',
                          attributes: $({}, Tt, { fill: 'white' }),
                      }),
                      (I = z.children ? { children: z.children.map(_t) } : {}),
                      (T = {
                          tag: 'g',
                          attributes: $({}, R.inner),
                          children: [
    ...
    function re(t, e, n) {
        var a,
            ...
            l =
                ...
                r);
        l && !Kt(e) && (Bt(t, u({}, e, l), { skipHooks: !0 }), se()),
    ...
    function de(t) {
        return t.reduce(function (t, e) {
            ...
            if (fe[e]) t.prefix = e;
                ...
                var a =
                    'fa' === t.prefix
                        ? ae[n] || { prefix: null, iconName: null }
                        : {};
    ...
    function Se(t) {
        ...
        return (
            ...
            o.prefix && 1 < i.length
                ? (o.iconName =
                      ((e = o.prefix), (n = t.innerText), (ne[e] || {})[n]))
                : o.prefix &&
                  1 === i.length &&
    ...
    var Ne = { fill: 'currentColor' },
        ...
        Le = {
            ...
            children: [
                ...
                {
                    tag: 'circle',
                    attributes: $({}, Ne, { cx: '256', cy: '364', r: '28' }),
                    children: [
                        {
                            tag: 'animate',
                            attributes: $({}, Pe, {
                        ...
                        {
                            tag: 'animate',
                            attributes: $({}, ze, { values: '1;0;1;1;0;1;' }),
                        },
                    ],
                },
                {
                    ...
                    children: [
                        {
                            tag: 'animate',
                            attributes: $({}, ze, { values: '1;0;0;0;0;1;' }),
                        },
                    ],
                },
                {
                    ...
                    children: [
                        {
                            tag: 'animate',
                            attributes: $({}, ze, { values: '0;0;1;1;0;0;' }),
                        },
                    ],
                },
            ],
    ...
    function Fe(o, c) {
        return new St(function (n, t) {
            var a = { found: !1, width: 512, height: 512, icon: Le };
            if (o && c && je[c] && je[c][o]) {
                var e = je[c][o];
                return n(Re(e));
            }
    ...
    function Te(t) {
        ...
        return ~a.extra.classes.indexOf(j)
            ...
            : ((i = t),
              ...
              (m = e.extra),
              new St(function (r, t) {
                  St.all([Fe(o, l), Fe(n.iconName, n.prefix)]).then(function (
                      t,
                  ) {
                      var e = h(t, 2),
                          n = e[0],
            ...
            ((Be = function (t) {
                ...
                if (t) {
                    var w = t.prefix,
                        x = t.iconName,
                        k = t.icon;
                    return Ge($({ type: 'icon' }, t), function () {
                        return (
                            Xe(),
                            et.autoA11y &&
                                (u
                            ...
                            Ut({
                                ...
                                maskId: l,
                                titleId: m,
                                extra: { attributes: v, styles: y, classes: p },
                            })
                        );
                    });
                }
        ...
        tn = {
            ...
            text: function (t) {
                var e =
                    ...
                    f = e.styles,
                    u = void 0 === f ? {} : f;
                return Ge({ type: 'text', content: t }, function () {
                    return (
                        Xe(),
                        Ht({
                            content: t,
            ...
            counter: function (t) {
                var e =
                    ...
                    s = e.styles,
                    l = void 0 === s ? {} : s;
                return Ge({ type: 'counter', content: t }, function () {
                    return (
                        Xe(),
                        (function (t) {
                            var e = t.content,
